...
public class Main {//construcktor
    static Client client = new Client();//variabel
    static Petugas petugas = new Petugas();//mthod deklarasi
    static Transaksi transaksi = new Transaksi();//mnbah objek baru
    static JenisLaundry jenislaundry = new JenisLaundry();
    static Scanner input = new Scanner(System.in);//objek
