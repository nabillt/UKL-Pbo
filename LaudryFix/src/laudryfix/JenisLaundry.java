...
public class JenisLaundry {
    ...
    public int size(){
        return this.jenisLaundry.size();//size nm method
    }
    ...
    public void setDurasi(int durasi){
        this.durasi.add(durasi);//menambah objek yang berada di add
    }
    public String getLaundry(int id){
        return this.jenisLaundry.get(id);//mengecek banyak jumlah array
    }
